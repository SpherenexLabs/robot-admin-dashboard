...
//   useEffect(() => {
//     const robotRouteRef = ref(db, 'College_Introduction_Roboot');
...
//     update(ref(db, 'College_Introduction_Roboot'), {
...
//     set(ref(db, 'College_Introduction_Roboot'), {
//       direction: "S",
//       duration: 0,
//       timestamp: new Date().toISOString(),
//       sensor: null,
...
function App() {
  ...
  const pauseForDetection = () => {
    ...
    // Stop robot
    update(ref(db, 'College_Introduction_Roboot'), { Movements: "S" });
  ...
  const handleStop = () => {
    ...
    // Stop robot (use update to avoid overwriting other fields under College_Introduction_Roboot)
    update(ref(db, 'College_Introduction_Roboot'), {
      Movements: "S",
      duration: 0,
      timestamp: new Date().toISOString(),
